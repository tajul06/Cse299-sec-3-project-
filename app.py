...
google = oauth.register(
    ...
    client_secret='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',
...
def extract_and_add_students(course_id, google_sheets_link):
    ...
    credentials = ServiceAccountCredentials.from_json_keyfile_name('creds_dev.json', scope)
...
def generate_google_form(assessment_id):
    ...
    credentials = service_account.Credentials.from_service_account_file(
        'creds_dev.json',  # Replace with your service account credentials file path
